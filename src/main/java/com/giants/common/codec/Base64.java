...
public final class Base64 {
    ...
    public static String encodeForUrl(byte[] bytes) {
        ...
        String encodeForUrl = new String(encode(bytes));
        //转成针对url的base64编码
    ...
    public static String decodeForUrl(String data) {
        if (data == null)
            return null;
        data = urlRestoreStanderdBase64(data);
        return new String(decode(data.getBytes()));
    }

    public static String decodeForUrl(byte[] bytes) {
        String data = new String(bytes);
        return decodeForUrl(data);
    }

    public static String urlRestoreStanderdBase64(String urlBase64) {
        urlBase64 = decodeSpecialLetter1(urlBase64);
...
class InvalidBase64CharacterException extends IllegalArgumentException {
    ...
    private static final long serialVersionUID = 2926005079587896078L;
